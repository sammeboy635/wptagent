...
class DesktopBrowser(BaseBrowser):
    ...
    def __init__(self, path, options, job):
        logs.write("Init DesktopBrowser")
    ...
    def prepare(self, job, task):
        ...
        logs.write("Preparing the Browser")
        self.stopping = False
        self.task = task
    ...
    def modify_hosts(self, task, hosts):
        ...
        logs.write("Modifying host files")
    ...
    def close_browser(self, job, _task):
        ...
        logs.write("Closing the Browser")
    ...
    def on_start_recording(self, task):
        ...
        if self.must_exit:
            return
        logs.write("Starting Video Recording")
        import psutil
        if task['log_data']:
    ...
    def on_start_processing(self, task):
        ...
        if self.must_exit:
            return
        logs.write('Starting Processing')
    ...
    def wait_for_processing(self, task):
        ...
        logs.write('Waiting for background threads to finish processing')
